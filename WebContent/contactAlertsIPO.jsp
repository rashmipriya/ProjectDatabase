...
<div class="nav-bar">
	<div class="container">
		<ul class="nav">
			...
			<li><a href="alertsToIPO.jsp">Illegal Doc Access</a></li>
...
<div class="content">
<div class="main">
<sql:setDataSource var="alerts_contacts" driver="com.mysql.jdbc.Driver"
     url="jdbc:mysql://localhost:3306/chinese_wall?useSSL=false"
     user="root"  password="root"/>
 
<sql:query dataSource="${alerts_contacts}" var="result">
SELECT * from alerts_contacts;
</sql:query>
<b>Here is the list of person IDs with requested contact IDs of which they tried to contact illegally!!</b>
<br>
<br>
<br>
...
<tr>
   <th>Person ID</th>
   <th>Requested Contact ID</th>
</tr>
<c:forEach var="row" items="${result.rows}">
<tr>
   <td><c:out value="${row.person_id}"/></td>
   <td><c:out value="${row.requested_id}"/></td>
</tr>
</c:forEach>
</table>
</div>
